import { _ as _defineProperty, i as _typeof, a as _inherits, b as _createSuper, d as _classCallCheck, c as _createClass, e as _assertThisInitialized, f as _slicedToArray } from './_rollupPluginBabelHelpers-b0f6ca49.js';
...
import { w as watchModel, M as Model } from './Model-6638e4fc.js';
import ReactDOM from 'react-dom';
import { T as Trigger } from './Trigger-b4785be2.js';
  ...
  function Wrapper(props) {
    ...
    _defineProperty(_assertThisInitialized(_this), "setValues", function (values) {
      _this.setState({
        ...
        var value = multiple ? values : values.length && values[0].value;
    ...
    watchModel(props.model, function () {});
    return _this;
  }
  ...
  _createClass(Wrapper, [{
    ...
    value: function getSelector(close, multiple) {
      ...
      return function (selected, option) {
        var values = [].concat(_this2.state.values);
    ...
    value: function render() {
      ...
      var _this$props2 = this.props,
          ...
          calc = _this$props2.calc,
          children = _this$props2.children,
          className = _this$props2.className,
          footer = _this$props2.footer,
          neck = _this$props2.neck,
      ...
      return /*#__PURE__*/React__default.createElement(Trigger, {
        ...
        var onSelect = isHidden ? null : _this3.getSelector(close, multiple);
